// pdfs.ts - All PDF resources for Cambridge IGCSE International Mathematics (0607)
import { ExternalResource } from '../types';

export const pdfResources: { [unitId: string]: { [subtopicSlug: string]: ExternalResource[] } } = {
  'unit-1': {
    'natural-numbers': [
  ...
  'unit-4': {
    ...
    'length-of-line': [
      { title: 'Dr Austin Maths – Midpoints and Lengths of Lines Worksheet', url: 'https://www.draustinmaths.com/coordinates-and-linear-graphs', source: 'Dr Austin Maths', type: 'pdf' },
      { title: 'Fullerton SD - Length of Line Segments Worksheet', url: 'https://www.fullertonsd.org/cms/lib/CA50010905/Centricity/domain/1073/math/Extra%20Practice%20and%20Support/9_2_Extra_Practice_L2.pdf', source: 'Fullerton SD', type: 'pdf'},
